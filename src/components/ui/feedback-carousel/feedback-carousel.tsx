...
export const FeedbackCarouselUI: FC<TFeedbackCarouselProps> = memo(
  ({ feedbacks, isLoading, settingsAdditional }) => {
    const settings = {
      ...settingsAdditional,
      ...
      <section className={styles.feedbackSection}>
        <div className={styles.sectionTitle}>
          ...
          <p className={styles.text}>
            Our customers’ feedback is the best recommendation! Find out why
            they choose us to service their vehicles. Professionalism, quality
            and taking care of your vehicle is our priority.
          </p>
        </div>
