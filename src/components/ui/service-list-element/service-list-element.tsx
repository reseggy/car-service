...
export const ServiceListElementUI: FC<TServiceListElementProps> = memo(
  ({ title, text, imgSrc, imgAlt, target, onClick }) => {
        ...
        {target === 'main' ? (
          ...
          >
            ...
            <div className={`${styles.itemText} ${styles.itemTextAdditional}`}>
              ...
              <p className={`${styles.text} ${styles.textAdditional}`}>
                {text}
              </p>
            </div>
          </button>
